...
export default function GamesPage() {  
  ...
  useEffect(() => {
    const loadScript = () => {
      ...
      script.src = '/cpanel/lib/thirdweb-unity-bridge.js';
      script.async = true;
  ...
  const { unityProvider, isLoaded, requestFullscreen, loadingProgression } = useUnityContext({
    loaderUrl: '/cpanel/Build/cpanel.loader.js',
    dataUrl: '/cpanel/Build/cpanel.data',
    frameworkUrl: '/cpanel/Build/cpanel.framework.js',
    codeUrl: '/cpanel/Build/cpanel.wasm',
  });
