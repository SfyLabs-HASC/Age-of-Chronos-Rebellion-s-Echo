...
async function main() {
  ...
  for (const key in contractItemAddresses) {
    if (contractItemAddresses.hasOwnProperty(key)) {
      ...
      console.log(`Total assets for ${key} collection: ${totalAssets}`);
...
/*
  for (const key in contractItemAddresses) {
    ...
    */
 // Call the getChildCollectionAddresses function
 const childCollectionAddresses = await manager.getChildCollectionAddresses();

// Log the child collection addresses with numbers from 1 to 16
console.log('Child Collection Addresses:');
console.log(`1. AriaBodyCollection: ${childCollectionAddresses[0]}`);
console.log(`2. AriaHeadCollection: ${childCollectionAddresses[1]}`);
console.log(`3. AriaLeftHandCollection: ${childCollectionAddresses[2]}`);
console.log(`4. AriaRightHandCollection: ${childCollectionAddresses[3]}`);
console.log(`5. LunaBodyCollection: ${childCollectionAddresses[4]}`);
console.log(`6. LunaHeadCollection: ${childCollectionAddresses[5]}`);
console.log(`7. LunaLeftHandCollection: ${childCollectionAddresses[6]}`);
console.log(`8. LunaRightHandCollection: ${childCollectionAddresses[7]}`);
console.log(`9. RykerBodyCollection: ${childCollectionAddresses[8]}`);
console.log(`10. RykerHeadCollection: ${childCollectionAddresses[9]}`);
console.log(`11. RykerLeftHandCollection: ${childCollectionAddresses[10]}`);
console.log(`12. RykerRightHandCollection: ${childCollectionAddresses[11]}`);
console.log(`13. ThaddeusBodyCollection: ${childCollectionAddresses[12]}`);
console.log(`14. ThaddeusHeadCollection: ${childCollectionAddresses[13]}`);
console.log(`15. ThaddeusLeftHandCollection: ${childCollectionAddresses[14]}`);
console.log(`16. ThaddeusRightHandCollection: ${childCollectionAddresses[15]}`);
